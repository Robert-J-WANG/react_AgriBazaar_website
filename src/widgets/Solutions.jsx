...
function Solutions() {
    return (
        <div>
            <SectionHeading title='Solutions 1' subTitle='Perferendis debitis fuga eaque pariatur?' />
            <div className='grid lg:grid-cols-2 mt-20 gap-20'>

                {/* left part */}
                <div >
                    <h3 className='mt-7 text-3xl font-bold '>dignissimos maxime odit eveniet</h3>
                    <p className='mt-4 mb-8 text-gray-500'>maiores tempore doloribus laboriosam quaerat, nisi totam inventore impedit fuga? Ut.
                    </p>
                    <ul className='grid gap-3'>
                        {[1, 2, 3].map(v => (
                            <li className={`p-5 justify-between rounded border border-zinc-100 ${v === 1 && 'bg-zinc-100'}`} key={v}>

                                <p className='text-lg font-bold'>Facilis eaque rem sequi amet. </p>

                                <div className="flex justify-between relative">
                                    <p className="text-lg leading-7 mt-1">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur harum hic maxime impedit.
                                    </p>
                                    <svg
                                        width="38"
                                        height="38"
                ...
                {/* right part */}
                <div className='grid items-center rounded-3xl overflow-hidden'>
                    <img src={Image1} alt="" />
                </div>
            </div>
        </div>
